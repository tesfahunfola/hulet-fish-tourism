...
export default function Header({ userRole, onToggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 shadow-sm z-40 relative">
        ...
        <div className="flex-1 max-w-md mx-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600 focus:border-amber-500 dark:focus:border-amber-400 focus:ring-amber-500 dark:focus:ring-amber-400"
            />
          </div>
        </div>
            ...
            {userRole === "admin" && (
              <>
                <Button
                  variant="outline"
                  size="sm"
                  className="border-gray-300 dark:border-gray-600 hover:border-amber-500 dark:hover:border-amber-400"
                >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="relative hover:bg-gray-100 dark:hover:bg-gray-800">
                ...
                {unreadMessages > 0 && (
                  <Badge className="absolute -top-1 -right-1 w-5 h-5 p-0 bg-blue-600 text-white text-xs border-2 border-white dark:border-gray-900">
                    {unreadMessages}
                  </Badge>
                )}
              </Button>
            ...
            <DropdownMenuContent
              align="end"
              className="w-80 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-xl"
            >
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="relative hover:bg-gray-100 dark:hover:bg-gray-800">
                ...
                {unreadNotifications > 0 && (
                  <Badge className="absolute -top-1 -right-1 w-5 h-5 p-0 bg-red-600 text-white text-xs border-2 border-white dark:border-gray-900">
                    {unreadNotifications}
                  </Badge>
                )}
              </Button>
